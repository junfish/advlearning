...
if __name__ == "__main__":
    ...
    if args.dataset == 0:
        ...
        if args.model == 0:
            ...
            my_model = base_model.myResNet18(pretrained=False, input_channels=1, first_padding=3, num_classes=10)
    ...
    experiment_op.save_model(path = "model_weights/mnist-resnet18.pth")
